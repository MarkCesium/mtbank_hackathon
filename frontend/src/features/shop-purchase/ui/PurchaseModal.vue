...
<template>
  <Teleport to="body">
    <div
      class="fixed inset-0 z-50 flex items-end justify-center bg-brand-black/50 backdrop-blur-sm"
      @click.self="handleClose"
    >
      <div class="w-full max-w-md bg-brand-white rounded-t-3xl p-6 pb-10 shadow-2xl">
        ...
        <template v-if="isSuccess && data">
          ...
          <div class="flex items-center justify-between mb-5">
            ...
            <span class="font-digital text-brand-primary font-bold text-xl">
              {{ data.new_balance }} <span class="text-sm font-main font-normal">баллов</span>
            </span>
          </div>
          <button
        ...
        <template v-else>
          ...
          <div class="flex items-center justify-between bg-brand-gray rounded-2xl p-4 mb-5">
            ...
            <span class="font-digital text-brand-dark font-bold text-xl">
              {{ item.price }} <span class="text-sm font-main font-normal">баллов</span>
            </span>
          </div>
